...
//************ RADIO MODULE *************
//#define BATTERY_ONLY
#define NODEID 10 // (1 to 30)  //  sensnode with DS set ID 1-5 , sensnode without DS set ID 6-9, senspowermon with tank level set ID 10, other senspowermon set ID 11-15, other nodes 16-39, basenode 30   
#define NETWORK 210
...
#define RADIO_SYNC_MODE 1 // 1 for power 2 for WDT , battery mode Power-down mode during wait: 0 = NORMAL, 1 = IDLE, 2 = STANDBY  http://jeelabs.net/pub/docs/jeelib/RF12_8h.html#a6843bbc70df373dbffa0b3d1f33ef0ae http://jeelabs.net/pub/docs/jeelib/RF12_8h.html#a6843bbc70df373dbffa0b3d1f33ef0ae
/*****************************REMAPING I2C *********************************************/
...
//*********** DS18B20 ******************
//#define DS_COUNT 3 //  if not used and set 1-10 number DS - max 10 sensors - 10 x 2 bytes (2 bytes for 1 DS) in case when emon is not used or used for 1 phase
...
#define NSENSORS 3 // change number only if you use 1 node with emon, 1 -3 are allowed, comment if you not use emon
