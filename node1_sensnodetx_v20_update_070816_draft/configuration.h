...
#define TXPOWER 2 ////txpower RF12b control variable byte txPower=0;  0 -max power, 7 -minimum there is last byte of comand control rf12_control(0x9850) -means max, rf12_control(0x9857); -means min -21dbm
...
//*********** SETTINGS ******************/
#define WAIT_TIME_MULTIPLY 1 //it gives multiply of Sleepy::loseSomeTime(60000);  65535 - is maximum value for waiting ~65 s and sleepy watchdog value can be 1 to 65535 - it gives waiting for send max 65535 min
#define RADIO_SYNC_MODE 0 // 1 for power 2 for WDT , battery mode Power-down mode during wait: 0 = NORMAL, 1 = IDLE, 2 = STANDBY  http://jeelabs.net/pub/docs/jeelib/RF12_8h.html#a6843bbc70df373dbffa0b3d1f33ef0ae
/*****************************REMAPING I2C *********************************************/
