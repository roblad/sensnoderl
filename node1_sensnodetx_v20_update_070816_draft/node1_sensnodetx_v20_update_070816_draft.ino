...
volatile byte pendingOutput = 0; //control redines for sending
...
long debouncing_time = 15; //Debouncing Time in Milliseconds for buttons 
volatile unsigned long last_millis; //buttons pressing time
...
volatile float ratio = 0; //ratio for gas sensor
