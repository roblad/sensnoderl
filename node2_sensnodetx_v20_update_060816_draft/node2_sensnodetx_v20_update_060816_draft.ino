...
// Analog
#ifdef NEW_REV //3.4/4
#define LDR_PIN 7 //standard 2 nano 6 /new 7
#define BAT_VOL 6 //standard 3 nano 7 /new 6
#else //3.0
#define LDR_PIN 0
#define BAT_VOL 1
#define CustomA3 3
...
void onPulse() {
    ...
    //debouncer.update();
     //int valuedebouncer = debouncer.read();
       
       //if  (valuedebouncer == LOW){ // Sometimes we get interrupt on RISING
       //((long)(micros() -lastBlink)>50000L &&
          ...
          pulseCount++;           //pulseCounter      
            ...
            //delay(2);
            //Serial.println(test);
            Serial.print("Current measure: ");delay(2); Serial.println(measure.pulse);
