...
#define NODEID 3 // (1 to 30)  //  sensnode with DS set ID 1-5 , sensnode without DS set ID 6-9, senspowermon with tank level set ID 10, other senspowermon set ID 11-15, other nodes 16-39, basenode 30   
#define NETWORK 210
...
//*********** SETTINGS ******************/
#define WAIT_TIME_MULTIPLY 6 //it gives multiply of Sleepy::loseSomeTime(60000);  65535 - is maximum value for waiting ~65 s and sleepy watchdog
