...
#define NODEID 4 // (1 to 30)  //  sensnode with DS set ID 1-5 , sensnode without DS set ID 6-9, senspowermon with tank level set ID 10, other senspowermon set ID 11-15, other nodes 16-39, basenode 30   
#define NETWORK 210
...
//*********** SETTINGS ******************/
#define WAIT_TIME_MULTIPLY 10 //it gives multiply of Sleepy::loseSomeTime(60000);  65535 - is maximum value for waiting ~65 s and sleepy watchdog
...
//#define SOLAR 1 // SOLAR VOLTAGE
//*********** DEFINE STRUCTURE FIRST BEFORE GO ON ******************
//*********** DS18B20 ******************
#define DS_COUNT 1 //  if not used and set 1-10 number DS - max 10 sensors - 10 x 2 bytes (2 bytes for 1 DS) in case when emon is not used or used for 1 phase
